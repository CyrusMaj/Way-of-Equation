...
public class BasicLinearEquation_03 : MonoBehaviour
{
    ...
    public static float equationChoice;
    ...
    [SerializeField] Text eEnemy;
    [SerializeField] Text xEnemy;
    ...
    void Start()
    {
        ...
        eEnemy.text = rand.ToString();

        float rand_2 = Random.Range(1, 9);
        xEnemy.text = rand_2 + "x";
    }
    ...
    public void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.tag == "Slope_Enemy")
        {
        ...
        if (other.gameObject.tag == "Constant_Enemy")
        {
        ...
        if (other.gameObject.tag == "Constant_X_Enemy")
        {
        ...
        if (other.gameObject.tag == "Enemy")       //If attacking Enemy
        {
