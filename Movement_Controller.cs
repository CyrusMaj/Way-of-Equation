...
public class Movement_Controller : MonoBehaviour
{
    ...
    void Update ()
    {
        //Get character to move in 4 directions.
        ...
        //Get character to only rotate on Y-Axis.
        Vector3 targetPosition = new Vector3(lookAt_Target.transform.position.x, transform.position.y, lookAt_Target.transform.position.z);
